...
% 2. Vsak matematični izraz mora biti v matematičnem načinu, četudi je samo en znak.
...
% 1. Ne delamo praznih vrstic pred in za izrazom, razen če se s formulo konča stavek.
...
Z okoljem \texttt{gather} postavimo izraze enega pod drugega:
%
\begin{gather*}
...
poravnana levo, zadnja desno in vse vmesne sredinsko:
%
\begin{multline*}
...
% Tu uporabimo \qedhere, da se znak vstavi kar v formulo.
\begin{proof}
  To sledi iz računa
  %
  \begin{align*}
